...
public class RelatedMoviesAdapter2 extends RecyclerView.Adapter<RelatedMoviesAdapter2.ViewHolder> {
    ...
    public RelatedMoviesAdapter2(Context context, List<MovieRelatedChannel> movies, OnMovieClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_related_movie2, parent, false);
