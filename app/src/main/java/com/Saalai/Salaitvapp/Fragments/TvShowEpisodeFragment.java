...
import com.Saalai.Salaitvapp.Adapters.TvShowEpisodeAdapter;
import com.Saalai.Salaitvapp.ApiService.ApiClient;
import com.Saalai.Salaitvapp.ApiService.ApiService;
import com.Saalai.Salaitvapp.Models.TvShowEpisode;
...
import com.Saalai.Salaitvapp.ShimmerAdapter.ShimmerTvShowEpisodeAdapter;
                            ...
                            try {
                                ...
                                if (status) {
                                    ...
                                    if (episodeDetails != null && offset == 0) {
                                        ...
                                        String episodeNo = episodeDetails.optString("episodeNo", "");
                                        String episodeType = episodeDetails.optString("episodeType", "");
...
// For subtitle
                                            if (episodeNo != null && !episodeNo.trim().isEmpty()) {
                                                subtitle.setText("Episode - " + episodeNo);
...
// For description
                                            if (episodeType != null && !episodeType.trim().isEmpty()) {
                                                description.setText(episodeType);
                                    ...
                                    if (array.length() > 0) {
                                        ...
                                        if (recyclerView.getAdapter() instanceof ShimmerTvShowEpisodeAdapter) {
                                            ...
                                            adapter = new TvShowEpisodeAdapter(getContext(), episodeList, episode -> {
                                            ...
                                            drawerAdapter = new TvShowEpisodeAdapter(getContext(), episodeList, episode -> {
                                                // When an episode is clicked, fetch its details to play
                                                fetchEpisodeUrlAndPlay(episode.getEpisodeId(), episode);
                                            });
