...
public class TvShowEpisodeAdapter2 extends RecyclerView.Adapter<TvShowEpisodeAdapter2.ViewHolder> {

    private Context context;
    private List<TvShowEpisode> episodeList;
    private OnEpisodeClickListener listener;

    public TvShowEpisodeAdapter2(Context context, List<TvShowEpisode> episodeList, OnEpisodeClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.related_tvshow, parent, false);
