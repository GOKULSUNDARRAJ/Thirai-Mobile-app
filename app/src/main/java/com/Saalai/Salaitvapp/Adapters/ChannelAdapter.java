...
public class ChannelAdapter extends RecyclerView.Adapter<ChannelAdapter.ViewHolder> {
    ...
    private boolean isAccountBlocked = false; // Add this
    private String blockedMessage = ""; // Add this

    public ChannelAdapter(Context context, List<Channel> channelList, OnItemClickListener listener) {
