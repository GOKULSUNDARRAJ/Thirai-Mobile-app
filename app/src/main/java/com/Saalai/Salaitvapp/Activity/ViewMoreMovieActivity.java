...
public class ViewMoreMovieActivity extends AppCompatActivity {

    private static final String TAG = "ViewMoreMovieActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View rootView = findViewById(R.id.main); // your root layout ID
        if (rootView != null) {
        ...
        if (getIntent() != null) {
            ...
            Log.d(TAG, "➡️ CategoryId from intent: " + categoryId);
            Log.d(TAG, "➡️ CategoryName from intent: " + categoryName);
                    ...
                    try {
                        ...
                        if (movieArray != null && movieArray.size() > 0) {
                            ...
                            if (movieRecyclerView.getAdapter() instanceof ShimmerMovieListAdapter) {
                                movieListAdapter = new MovieListAdapter(ViewMoreMovieActivity.this, movieList);
                                movieRecyclerView.setAdapter(movieListAdapter);
                            } else {
                    ...
                    try {
                        if (response.errorBody() != null) {
                            ...
                            if (jsonObject.has("error") && "access_denied".equals(jsonObject.getString("error"))) {
                                Toast.makeText(ViewMoreMovieActivity.this, "Access Denied", Toast.LENGTH_SHORT).show();
                                callLogoutApi();
                            } else {
    ...
    private void callLogoutApi() {
        SharedPrefManager sp = SharedPrefManager.getInstance(ViewMoreMovieActivity.this);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    Intent intent = new Intent(ViewMoreMovieActivity.this, SignUpActivity.class);
    ...
    private void setupCloseReceiver() {
        closeReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if ("CLOSE_ViewMoreMovieActivity".equals(intent.getAction())) {
                    finish();
                }
            }
        };

        IntentFilter filter = new IntentFilter("CLOSE_ViewMoreMovieActivity");
