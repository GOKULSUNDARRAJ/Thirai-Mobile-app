...
public class ShimmerAdapterfocatchup extends RecyclerView.Adapter<ShimmerAdapterfocatchup.ShimmerViewHolder> {

    private final int itemCount;

    public ShimmerAdapterfocatchup(int itemCount) {
    ...
    public ShimmerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_channel_shimmer, parent, false);
