package com.Saalai.Salaitvapp.ShimmerAdapter;
...
public class ShimmerTvShowEpisodeAdapter extends RecyclerView.Adapter<ShimmerTvShowEpisodeAdapter.ShimmerViewHolder> {

    private final int itemCount;

    public ShimmerTvShowEpisodeAdapter(int itemCount) {
    ...
    public ShimmerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_shimmer_tv_episode, parent, false);
