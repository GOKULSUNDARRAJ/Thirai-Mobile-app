...
public class HelpandSupportActivity extends AppCompatActivity {
    ...
    private void getHelpData() {
        ...
        Call<ResponseBody> call = apiService.getHelp();
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        ...
                        Log.d("HelpResponse", jsonString);

                        JSONObject jsonObject = new JSONObject(jsonString);
                        JSONObject responseObject = jsonObject.getJSONObject("response");

                        String title = responseObject.getString("title");
                        String helpText = responseObject.getString("help");
                        ...
                        e.printStackTrace();
                        Toast.makeText(HelpandSupportActivity.this, "Parse error", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(HelpandSupportActivity.this, "Failed to load help info", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Log.e("HelpError", "API call failed", t);
                Toast.makeText(HelpandSupportActivity.this, "Network error", Toast.LENGTH_SHORT).show();
            }
        });
    }
