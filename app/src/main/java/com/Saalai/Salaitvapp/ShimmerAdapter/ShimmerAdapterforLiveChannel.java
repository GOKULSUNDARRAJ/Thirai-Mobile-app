...
public class ShimmerAdapterforLiveChannel extends RecyclerView.Adapter<ShimmerAdapterforLiveChannel.ShimmerViewHolder> {

    private final int itemCount;

    public ShimmerAdapterforLiveChannel(int itemCount) {
    ...
    public ShimmerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_catchup_shimmer, parent, false);
