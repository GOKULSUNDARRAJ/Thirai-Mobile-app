...
import com.Saalai.Salaitvapp.Response.CatchUpChannelDetailsResponse;
import com.Saalai.Salaitvapp.SharedPrefManager.SharedPrefManager;
import com.Saalai.Salaitvapp.ShimmerAdapter.ShimmerAdapterfocatchupdetail;
import com.Saalai.Salaitvapp.ShimmerAdapter.ShimmerAdapterfocatchuptab;
...
public class CatchUpDetailFragment extends Fragment implements EpisodeListFragment.EpisodeClickListener {
    ...
    private void initViews(View view) {
        ...
        newbackimg= view.findViewById(R.id.backimgnew);
        ...
        LinearLayout rootview=view.findViewById(R.id.root_view);
    ...
    private void setupClickListeners() {
        ...
        newbackimg.setOnClickListener(v -> handleBackNavigation());
    ...
    private void setupShimmerRecyclerViews() {
        ...
        GridLayoutManager shimmerContentLayout = new GridLayoutManager(requireContext(), 2);
    ...
    private void showLoading(boolean show) {
        if (show) {
            ...
            newbackimg.setVisibility(View.GONE);
        } else {
    ...
    private void showError(String message) {
        ...
        newbackimg.setVisibility(VISIBLE);
    }
